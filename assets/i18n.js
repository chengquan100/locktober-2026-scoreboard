...
const zhHant = {
  ...
  'hero.upcoming.lead': '活動即將開始：先看看計分規則，開始後這裡會即時更新。',
  'hero.ongoing.eyebrow': '活動進行中',
  'hero.ended.eyebrow': '最終成績',
  'hero.ended.lead': '活動已結束，本頁為封存檢視，不再更新即時分數。',
  'hero.day': 'Day {n}',
  'hero.dayof': '/ {total} 天',
  'hero.progress': '已完成 {done} / {total} 天',
  ...
  'grid.empty.desc': '活動開始並產生第一批得分後，這裡會出現完整排行。',
  ...
  'person.scoredDays': '有得分 {n} 天',
  'rules.title': '計分規則',
  'rules.items': ['每日打卡 5分：當日打卡被管理員標記 👌 表示打卡成功', '每日打卡與任務 10分：打卡與任務成功並被管理員標記為 🆒 時計分', '【加分】特殊任務 +10分：特殊任務成功並標記為 🆒 時計分', '【加分】連續獎勵 +10分：連續 5 天成功打卡可獲加分，中斷後重新累計連續天數', '每日任務時間：00:10~23:30 (UTC+8)', '限時任務時間：不固定😈''],
  'side.title': '活動進度',
  'side.window': '活動時間',
  'side.recorded': '已記錄天數',
  'side.updated': '最後更新',
